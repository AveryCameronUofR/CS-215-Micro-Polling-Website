...
document.getElementById("opInput0").addEventListener("keyup", updateOpCount, false);
document.getElementById("opInput1").addEventListener("keyup", updateOpCount, false);
